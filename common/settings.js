...
(function (OverviewNavigationState) {
  ...
  OverviewNavigationState[(OverviewNavigationState["WINDOW_PICKER_ONLY"] = 2)] =
    "WINDOW_PICKER_ONLY";
...
(function (ForwardBackKeyBinds) {
  ...
  ForwardBackKeyBinds[(ForwardBackKeyBinds["Forward/Backward"] = 1)] =
    "Forward/Backward";
  ForwardBackKeyBinds[(ForwardBackKeyBinds["Page Up/Down"] = 2)] =
    "Page Up/Down";
  ForwardBackKeyBinds[(ForwardBackKeyBinds["Right/Left"] = 3)] = "Right/Left";
  ForwardBackKeyBinds[(ForwardBackKeyBinds["Audio Next/Prev"] = 4)] =
    "Audio Next/Prev";
  ForwardBackKeyBinds[(ForwardBackKeyBinds["Tab Next/Prev"] = 5)] =
    "Tab Next/Prev";
