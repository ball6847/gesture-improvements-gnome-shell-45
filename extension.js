...
export default class GIExtension extends Extension {
  ...
  reload(_settings, key) {
    ...
    this._reloadWaitId = GLib.timeout_add(
      ...
      this._addReloadDelayFor.includes(key) ? RELOAD_DELAY : 0,
      () => {
        this._disable();
        this._enable();
        this._reloadWaitId = 0;
  ...
  _enable() {
    ...
    this._extensions.push(
      new OverviewRoundTripGestureExtension(
        this.settings.get_enum("overview-navifation-states")
      ),
    ...
    if (
      showDesktopFingers === null || showDesktopFingers === void 0
        ? void 0
        : showDesktopFingers.length
    )
    ...
    if (
      closeWindowFingers === null || closeWindowFingers === void 0
        ? void 0
        : closeWindowFingers.length
    )
      this._extensions.push(
    ...
    if (
      closeDocumentFingers === null || closeDocumentFingers === void 0
        ? void 0
        : closeDocumentFingers.length
    )
      this._extensions.push(
        new CloseWindowExtension(
    ...
    this._extensions.forEach((extension) => {
      var _a;
      return (_a = extension.apply) === null || _a === void 0
        ? void 0
        : _a.call(extension);
    });
  }
  ...
  _initializeSettings() {
    if (this.settings) {
      ...
      ExtSettings.DEFAULT_OVERVIEW_GESTURE =
        this.settings.get_boolean("default-overview");
      ExtSettings.ALLOW_MINIMIZE_WINDOW = this.settings.get_boolean(
        "allow-minimize-window"
      );
      ExtSettings.FOLLOW_NATURAL_SCROLL = this.settings.get_boolean(
      ...
      ExtSettings.APP_GESTURES = this.settings.get_boolean(
