...
(function (SwipeGestureDirection) {
  SwipeGestureDirection[(SwipeGestureDirection["LeftToRight"] = 1)] =
    "LeftToRight";
  SwipeGestureDirection[(SwipeGestureDirection["RightToLeft"] = 2)] =
    "RightToLeft";
...
export var ForwardBackGestureExtension = class ForwardBackGestureExtension {
  ...
  _getClutterKeyForFocusedApp(gestureDirection) {
    ...
    if (keyBind) {
      ...
      const returnBackKey =
        (gestureDirection === SwipeGestureDirection.LeftToRight) !== keyBind[1];
      switch (keyBind[0]) {
        ...
        case ForwardBackKeyBinds["Audio Next/Prev"]:
          return [
            returnBackKey ? Clutter.KEY_AudioPrev : Clutter.KEY_AudioNext,
          ];
