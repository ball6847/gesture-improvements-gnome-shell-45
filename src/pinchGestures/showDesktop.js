...
(function (WorkspaceManagerState) {
  ...
  WorkspaceManagerState[(WorkspaceManagerState["SHOW_DESKTOP"] = 1)] =
    "SHOW_DESKTOP";
...
class MonitorGroup {
  ...
  _fillCloneDestPosition(windowActorsClones) {
    ...
    let extraActors =
      windowActorsClones.length - this._corners.length * minActorsPerCorner;
    ...
    distanceMetrics.forEach((metric) => {
      var _a;
      const size =
        (_a = clusterSizes.get(metric.corner.position)) !== null &&
        _a !== void 0
          ? _a
          : 0;
...
export var ShowDesktopExtension = class ShowDesktopExtension {
  ...
  destroy() {
    ...
    if (this._windowAddedId)
      (_b = this._workspace) === null || _b === void 0
        ? void 0
        : _b.disconnect(this._windowAddedId);
    if (this._windowRemovedId)
      (_c = this._workspace) === null || _c === void 0
        ? void 0
        : _c.disconnect(this._windowRemovedId);
          ...
          return (
            ...
            (win.is_always_on_all_workspaces() ||
              win.get_workspace().index ===
                ((_a = this._workspace) === null || _a === void 0
                  ? void 0
                  : _a.index)) &&
            !win.minimized
          );
      ...
      const windowActors = this._minimizingWindows
        ...
        .filter((actor) => {
          return (
            ...
            actor.meta_window.get_monitor() === monitor.monitor.index
          );
        });
  ...
  _workspaceChanged() {
    ...
    if (this._windowAddedId)
      (_a = this._workspace) === null || _a === void 0
        ? void 0
        : _a.disconnect(this._windowAddedId);
    if (this._windowRemovedId)
      (_b = this._workspace) === null || _b === void 0
        ? void 0
        : _b.disconnect(this._windowRemovedId);
  ...
  _windowUnMinimized(_wm, actor) {
    var _a;
    if (
      actor.meta_window.get_workspace().index !==
      ((_a = this._workspace) === null || _a === void 0 ? void 0 : _a.index)
    )
      return;
    this._minimizingWindows = [];
    this._workspaceManagerState = WorkspaceManagerState.DEFAULT;
