  ...
  class TouchpadPinchGesture extends GObject.Object {
    _init(params) {
      ...
      this.PINCH_MULTIPLIER =
        ...
        ((_a = params.pinchSpeed) !== null && _a !== void 0 ? _a : 1.0);
    }
    ...
    _emitUpdate(time, pinch_scale) {
      ...
      const new_progress =
        Math.log2(pinch_scale) * this.PINCH_MULTIPLIER + this._initialProgress;
    ...
    _emitEnd(time) {
      ...
      let duration = Math.abs(
        ((this._progress_scale - endProgress) / velocity) * DURATION_MULTIPLIER
      );
      duration = Math.clamp(
        duration,
