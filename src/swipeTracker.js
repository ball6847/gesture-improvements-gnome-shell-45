...
export var TouchpadSwipeGesture = registerClass(
  ...
  class TouchpadSwipeGesture extends GObject.Object {
    ...
    _handleEvent(_actor, event) {
      ...
      if (this._state === TouchpadState.IGNORED) return Clutter.EVENT_PROPAGATE;
      ...
      let delta =
        (vertical !== this._toggledDirection ? dy : dx) * this.SWIPE_MULTIPLIER;
    ...
    isItHoldAndSwipeGesture() {
      ...
      return (
        this._holdGestureCancelTime - this._holdGestureBeginTime >=
          TouchpadConstants.HOLD_SWIPE_DELAY_DURATION && // ms
        this._swipeGestureBeginTime - this._holdGestureCancelTime <=
          Math.max(100, TouchpadConstants.HOLD_SWIPE_DELAY_DURATION) // ms
      );
    }
...
export function createSwipeTracker(
  ...
  params.allowDrag =
    (_a = params.allowDrag) !== null && _a !== void 0 ? _a : false;
  params.allowScroll =
    (_b = params.allowScroll) !== null && _b !== void 0 ? _b : false;
  const allowTouch =
    (_c = params.allowTouch) !== null && _c !== void 0 ? _c : true;
