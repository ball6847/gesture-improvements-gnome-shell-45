...
import { TouchpadSwipeGesture, createSwipeTracker } from "./swipeTracker.js";
...
export var GestureExtension = class GestureExtension {
    ...
    this._swipeTrackers = [
      {
        ...
        checkAllowedGesture: (event) => {
          if (
            Main.overview._overview._controls._searchController.searchActive
          ) {
            return false;
          }
  ...
  apply() {
    ...
    this._swipeTrackers.forEach((entry) => {
      ...
      const gestureSpeed =
        (_a = entry.gestureSpeed) !== null && _a !== void 0 ? _a : 1;
  ...
  destroy() {
    this._swipeTrackers.reverse().forEach((entry) => {
      ...
      (_a = swipeTracker._touchpadGesture) === null || _a === void 0
        ? void 0
        : _a.destroy();
