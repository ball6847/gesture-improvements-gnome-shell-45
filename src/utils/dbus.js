...
const DBusWrapperGIExtension = registerClass(
  ...
  class DBusWrapperGIExtension extends GObject.Object {
    _init() {
      ...
      this._proxyConnectSignalIds.push(
        this._proxy.connectSignal(
          "TouchpadSwipe",
          this._handleDbusSwipeSignal.bind(this)
        )
      );
      this._proxyConnectSignalIds.push(
        this._proxy.connectSignal(
          "TouchpadHold",
          this._handleDbusHoldSignal.bind(this)
        )
      );
      this._proxyConnectSignalIds.push(
        this._proxy.connectSignal(
          "TouchpadPinch",
          this._handleDbusPinchSignal.bind(this)
        )
      );
    }
    ...
    dropProxy() {
      if (this._proxy) {
        this._proxyConnectSignalIds.forEach((id) =>
...
function GenerateEvent(typ, sphase, fingers, time, params) {
  return {
    ...
    get_gesture_motion_delta_unaccelerated: () => {
      var _a, _b;
      return [
        (_a = params.dx) !== null && _a !== void 0 ? _a : 0,
        (_b = params.dy) !== null && _b !== void 0 ? _b : 0,
      ];
    },
    get_time: () => time,
    get_gesture_pinch_scale: () => {
      var _a;
      return (_a = params.pinch_scale) !== null && _a !== void 0 ? _a : 1.0;
    },
    get_gesture_pinch_angle_delta: () => {
      var _a;
      return (_a = params.pinch_angle_delta) !== null && _a !== void 0 ? _a : 0;
    },
  };
}
...
export function subscribe(callback) {
  ...
  connectedSignalIds.push(
    proxy.connect(
      "TouchpadHold",
      (_source, sphase, fingers, time, is_cancelled) => {
        const event = GenerateEvent(
...
export function unsubscribeAll() {
  if (proxy) {
    connectedSignalIds.forEach((id) =>
      proxy === null || proxy === void 0 ? void 0 : proxy.disconnect(id)
    );
    connectedSignalIds = [];
  }
}
